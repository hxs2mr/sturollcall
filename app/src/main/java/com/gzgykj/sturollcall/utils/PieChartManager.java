...
//        显示试图
    ...
    public void  showRingPieChart(List<PieEntry> yvals, List<Integer> colors){
        ...
        pieChart.setHoleRadius(65f);//设置中间洞的大小
...
//        显示试图
     ...
     * @param colors
     */
    public void  showRingPieChartCenter(List<PieEntry> yvals, List<Integer> colors,String descript){
        //显示为圆环
        pieChart.setDrawHoleEnabled(true);
        pieChart.setHoleRadius(65f);//设置中间洞的大小
        //获取图例
        ...
        pieChart.setCenterText(descript); //设置中间文字
        pieChart.setCenterTextColor(Color.parseColor("#5298fc")); //中间问题的颜色
        pieChart.setCenterTextSizePixels(25);  //中间文字的大小px
        pieChart.setCenterTextRadiusPercent(1f);
        pieChart.setCenterTextTypeface(Typeface.DEFAULT); //中间文字的样式
        pieChart.setCenterTextOffset(0, 0); //中间文字的偏移量
